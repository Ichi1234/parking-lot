    ...
    <div className="bg-gray-900 pd-60 flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="flex flex-col w-full max-w-3xl">
        ...
        <div className="flex flex-wrap gap-2 mb-4 items-center justify-center">
          ...
          <input type="text" name="licensePlate" placeholder="License Plate" value={form.licensePlate} onChange={handleChange} className="border border-gray-400 px-2 py-1 rounded" />
          <select name="carType" id="carType" value={form.carType} onChange={handleChange} className="border border-gray-400 px-2 py-1 rounded">
          ...
          <button onClick={handleSubmit} className="px-4 py-1 bg-blue-500 text-white rounded">Park</button>
        </div>

        {/* Remove Car Form */}
        <div className="flex flex-wrap gap-2 mb-8 items-center justify-center">
          <h3 className="mr-2">Go Away The Car:</h3>
          <input type="text" name="licensePlate" placeholder="License Plate" value={goAwayForm.licensePlate} onChange={handleGoAwayChange} className="border border-gray-400 px-2 py-1 rounded" />
          <input type="text" name="floor" placeholder="Level" value={goAwayForm.floor} onChange={handleGoAwayChange} className="border border-gray-400 px-2 py-1 rounded" />
          <input type="text" name="spotID" placeholder="Spot ID" value={goAwayForm.spotID} onChange={handleGoAwayChange} className="border border-gray-400 px-2 py-1 rounded" />
          <select name="carType" id="carType" value={goAwayForm.carType} onChange={handleGoAwayChange} className="border border-gray-400 px-2 py-1 rounded">
            <option className="bg-gray-800" value="Motorcycle">Motorcycle</option>
            <option className="bg-gray-800" value="Car">Car</option>
            <option className="bg-gray-800" value="Bus">Bus</option>
          </select>
          <button onClick={carGoSubmit} className="px-4 py-1 bg-red-500 text-white rounded">Bye Bye Car</button>
        </div>
